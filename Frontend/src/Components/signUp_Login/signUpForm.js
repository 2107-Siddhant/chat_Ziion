...
import formimg from '../../assets/form/signupform.jpg'
...
const SignUpForm = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    dispatch(authActions.signupValidate({ formType: step1Complete ? "company" : "user" }));
  ...
  return (
    <div className={styles.form_main_div}>
      ...
      <img src={formimg} alt="form image" className={styles.formimg}></img>
      </div>
    <div className={styles.container}>
      ...
      <form onSubmit={handleSubmit} className={styles.form} action="/api/auth/signup">
        ...
        <button type="submit" className={styles.submitButton}>
          {step1Complete ? "Discover My Dashboard" : "Register"}
        </button>
